...
ggplot(data, aes(x = locality, y = as.numeric(average_price_m2_nominal_euros), fill = locality)) +
  geom_bar(stat = "identity") +
  labs(title = "Average Price per m² in 2010",
       x = "Locality",
       y = "Average Price per m² (Nominal Euros)") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+  scale_y_continuous(labels = scales::number_format(accuracy = 0.01))
```
